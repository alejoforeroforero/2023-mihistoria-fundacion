...
import { ItemHome } from "../classes/ItemHome.js?n=9";

export function pintarHome() {
  const enlace = "./scripts/secciones/home.css?n=9";
...
function pintarHero(padre) {
  ...
  video.poster = "./assets/imgs/hero-pc.jpg";
  video.src = "./assets/videos/hero-pc.mp4";
...
function pintarSeccionesHome() {
  ...
  testimonios.imgSrc = "assets/imgs/ninez.jpg?n=9";
  testimonios.poster = "assets/imgs/ninez-poster.jpg?n=9";
  testimonios.videoSrc = "./assets/videos/ninez.mp4?n=9";
  ...
  mihistoria.imgSrc = "assets/imgs/periodismo.jpg?n=9";
  mihistoria.videoSrc = "./assets/videos/periodismo2.mp4?n=9";
  mihistoria.poster = "assets/imgs/periodismo-poster.jpg?n=9";
  ...
  micamino.imgSrc = "assets/imgs/mi-camino.jpg?n=9";
  micamino.poster = "assets/imgs/mi-camino-poster.jpg?n=9";
  micamino.videoSrc = "./assets/videos/mi-camino.mp4?n=9";
  ...
  alguien.imgSrc = "assets/imgs/alguien.jpg?n=9";
  alguien.poster = "assets/imgs/alguien-poster.jpg?n=9";
  alguien.videoSrc = "./assets/videos/alguien.mp4?n=9";
  ...
  radio.imgSrc = "assets/imgs/radio.jpg?n=9";
  radio.poster = "assets/imgs/radio-poster.jpg?n=9";
  radio.videoSrc = "./assets/videos/radio.mp4?n=9";
