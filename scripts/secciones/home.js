...
import { ItemHome } from "../classes/ItemHome.js?n=21";

let radioPantalla;

export function pintarHome() {
  const enlace = "./scripts/secciones/home.css?n=21";
...
window.addEventListener("resize", ()=>{
  ...
  const videSrc = (radioPantalla > 1.4) ? "./assets/videos/hero-horizontal.mp4?n=21" : "./assets/videos/hero-vertical.mp4?n=21"

  const video = document.getElementById('video-hero');
  video.poster = "./assets/imgs/hero-pc.jpg?n=21";
  video.src = videSrc;
})
...
function pintarSeccionesHome() {
  ...
  testimonios.imgSrc = "assets/imgs/ninez.jpg?n=21";
  testimonios.poster = "assets/imgs/ninez-poster.jpg?n=21";
  testimonios.videoSrc = "./assets/videos/ninez.mp4?n=21";
  ...
  mihistoria.imgSrc = "assets/imgs/periodismo.jpg?n=21";
  mihistoria.videoSrc = "./assets/videos/periodismo.mp4?n=21";
  mihistoria.poster = "assets/imgs/periodismo-poster.jpg?n=21";
  ...
  micamino.imgSrc = "assets/imgs/mi-camino.jpg?n=21";
  micamino.poster = "assets/imgs/mi-camino-poster.jpg?n=21";
  micamino.videoSrc = "./assets/videos/mi-camino.mp4?n=21";
  ...
  alguien.imgSrc = "assets/imgs/alguien.jpg?n=21";
  alguien.poster = "assets/imgs/alguien-poster.jpg?n=21";
  alguien.videoSrc = "./assets/videos/alguien.mp4?n=21";
  ...
  radio.imgSrc = "assets/imgs/radio.jpg?n=21";
  radio.poster = "assets/imgs/radio-poster.jpg?n=21";
  radio.videoSrc = "./assets/videos/radio.mp4?n=21";
