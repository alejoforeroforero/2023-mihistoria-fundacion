...
import { ItemHome } from "../classes/ItemHome.js?n=7";

export function pintarHome() {
  const enlace = "./scripts/secciones/home.css?n=7";
...
function dibujarHome(){
    ...
    testimonios.imgSrc = 'assets/imgs/ninez.jpg?n=7';
    testimonios.videoSrc = './assets/videos/ninez.mp4?n=7';
    ...
    mihistoria.imgSrc = 'assets/imgs/periodismo.jpg?n=7';
    mihistoria.videoSrc = './assets/videos/periodismo2.mp4?n=7';
    ...
    micamino.imgSrc = 'assets/imgs/mi-camino.jpg?n=7';
    micamino.videoSrc = './assets/videos/mi-camino.mp4?n=7';
    ...
    alguien.imgSrc = 'assets/imgs/alguien.jpg?n=7';
    alguien.videoSrc = './assets/videos/alguien.mp4?n=7';
    ...
    radio.imgSrc = 'assets/imgs/radio.jpg?n=7';
    radio.videoSrc = './assets/videos/radio.mp4?n=7';
